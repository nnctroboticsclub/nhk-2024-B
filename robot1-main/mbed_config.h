...
#define CLOCK_SOURCE \
  USE_PLL_HSE_EXTC | USE_PLL_HSI                 // set by target:MCU_STM32F4
...
#define MBED_CONF_ATMEL_RF_FULL_SPI_SPEED_BYTE_SPACING \
  250  // set by library:atmel-rf
#define MBED_CONF_ATMEL_RF_IRQ_THREAD_STACK_SIZE \
  1024                                                // set by library:atmel-rf
...
#define MBED_CONF_EVENTS_SHARED_DISPATCH_FROM_APPLICATION \
  0                                                     // set by library:events
...
#define MBED_CONF_EVENTS_SHARED_HIGHPRIO_STACKSIZE \
  1024                                                // set by library:events
...
#define MBED_CONF_FAT_CHAN_FF_VOLUME_STRS          \
  "RAM", "NAND", "CF", "SD", "SD2", "USB", "USB2", \
      "USB3"                                       // set by library:fat_chan
...
#define MBED_CONF_FLASHIAP_BLOCK_DEVICE_SIZE \
  0  // set by library:flashiap-block-device
#define MBED_CONF_GEMALTO_CINTERION_BAUDRATE \
  115200  // set by library:GEMALTO_CINTERION
#define MBED_CONF_GEMALTO_CINTERION_PROVIDE_DEFAULT \
  0  // set by library:GEMALTO_CINTERION
#define MBED_CONF_GENERIC_AT3GPP_BAUDRATE \
  115200  // set by library:GENERIC_AT3GPP
#define MBED_CONF_GENERIC_AT3GPP_PROVIDE_DEFAULT \
  0                              // set by library:GENERIC_AT3GPP
#define MBED_CONF_LORA_ADR_ON 1  // set by library:lora
#define MBED_CONF_LORA_APPLICATION_EUI \
  { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }  // set by library:lora
...
#define MBED_CONF_LORA_FSB_MASK \
  { 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x00FF }  // set by library:lora
#define MBED_CONF_LORA_FSB_MASK_CHINA \
  { 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF }  // set by library:lora
...
#define MBED_CONF_LWIP_TCPIP_THREAD_PRIORITY \
  osPriorityNormal                                  // set by library:lwip
...
#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_CHANNEL \
  0  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_CHANNEL_MASK \
  0x7fff800  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_CHANNEL_PAGE \
  0  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_DEVICE_TYPE \
  NET_6LOWPAN_ROUTER  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_PANID_FILTER \
  0xffff  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_PSK_KEY                          \
  {                                                                         \
    0xa0, 0xa1, 0xa2, 0xa3, 0xa4, 0xa5, 0xa6, 0xa7, 0xa8, 0xa9, 0xaa, 0xab, \
        0xac, 0xad, 0xae, 0xaf                                              \
  }  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_PSK_KEY_ID \
  1  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_SECURITY_MODE \
  NONE  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_SEC_LEVEL \
  5                                              // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_HEAP_SIZE 32500  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_HEAP_STAT_INFO \
  NULL  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_MAC_NEIGH_TABLE_SIZE \
  32  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_RADIUS_RETRY_COUNT \
  3  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_RADIUS_RETRY_IMAX \
  30  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_RADIUS_RETRY_IMIN \
  20  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_SYSTEM_TIME_UPDATE_FROM_NANOSTACK \
  1  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_THREAD_CONFIG_CHANNEL \
  22  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_THREAD_CONFIG_CHANNEL_MASK \
  0x7fff800  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_THREAD_CONFIG_CHANNEL_PAGE \
  0  // set by library:mbed-mesh-api
...
#define MBED_CONF_MBED_MESH_API_THREAD_CONFIG_ML_PREFIX \
  { 0xfd, 0x0, 0x0d, 0xb8, 0x0, 0x0, 0x0, 0x0 }  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_THREAD_CONFIG_NETWORK_NAME \
  "Thread Network"  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_THREAD_CONFIG_PANID \
  0x0700  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_THREAD_CONFIG_PSKC                          \
  {                                                                         \
    0xc8, 0xa6, 0x2e, 0xae, 0xf3, 0x68, 0xf3, 0x46, 0xa9, 0x9e, 0x57, 0x85, \
        0x98, 0x9d, 0x1c, 0xd0                                              \
  }  // set by library:mbed-mesh-api
...
#define MBED_CONF_MBED_MESH_API_THREAD_MASTER_KEY                           \
  {                                                                         \
    0x10, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, \
        0xcc, 0xdd, 0xee, 0xff                                              \
  }  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_THREAD_PSKD \
  "ABCDEFGH"  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_THREAD_SECURITY_POLICY \
  255  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_THREAD_USE_STATIC_LINK_CONFIG \
  1  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_USE_MALLOC_FOR_HEAP \
  0  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_BC_CHANNEL_FUNCTION \
  255  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_BC_DWELL_INTERVAL \
  0  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_BC_FIXED_CHANNEL \
  65535  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_BC_INTERVAL \
  0  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_CHANNEL_PLAN_ID \
  255  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_DEVICE_TYPE \
  MESH_DEVICE_TYPE_WISUN_ROUTER  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_NETWORK_NAME \
  "Wi-SUN Network"  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_OPERATING_CLASS \
  255  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_OPERATING_MODE \
  255  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_PHY_MODE_ID \
  255  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_REGULATORY_DOMAIN \
  3  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_UC_CHANNEL_FUNCTION \
  255  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_UC_DWELL_INTERVAL \
  255  // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_UC_FIXED_CHANNEL \
  65535                                     // set by library:mbed-mesh-api
#define MBED_CONF_MCR20A_PROVIDE_DEFAULT 0  // set by library:mcr20a
#define MBED_CONF_NANOSTACK_CONFIGURATION \
  nanostack_full  // set by library:nanostack
...
#define MBED_CONF_NANOSTACK_HAL_EVENT_LOOP_DISPATCH_FROM_APPLICATION \
  0  // set by library:nanostack-hal
#define MBED_CONF_NANOSTACK_HAL_EVENT_LOOP_THREAD_STACK_SIZE \
  6144  // set by library:nanostack-hal
#define MBED_CONF_NANOSTACK_HAL_EVENT_LOOP_USE_MBED_EVENTS \
  0  // set by library:nanostack-hal
#define MBED_CONF_NANOSTACK_HAL_KVSTORE_PATH \
  "/kv/"                                       // set by library:nanostack-hal
...
#define MBED_CONF_NANOSTACK_LIBSERVICE_PRESENT \
  1  // set by library:nanostack-libservice
#define MBED_CONF_NSAPI_ADD_EVENT_LISTENER_RETURN_CHANGE \
  0                                                   // set by library:nsapi
...
#define MBED_CONF_PLATFORM_DEEPSLEEP_STATS_VERBOSE \
  0  // set by library:platform[STM]
#define MBED_CONF_PLATFORM_DEFAULT_SERIAL_BAUD_RATE \
  9600                                               // set by library:platform
#define MBED_CONF_PLATFORM_ERROR_ALL_THREADS_INFO 0  // set by library:platform
#define MBED_CONF_PLATFORM_ERROR_FILENAME_CAPTURE_ENABLED \
  0                                              // set by library:platform
...
#define MBED_CONF_PLATFORM_FATAL_ERROR_AUTO_REBOOT_ENABLED \
  0                                                   // set by library:platform
#define MBED_CONF_PLATFORM_MAX_ERROR_FILENAME_LEN 16  // set by library:platform
#define MBED_CONF_PLATFORM_MINIMAL_PRINTF_ENABLE_64_BIT \
  1  // set by library:platform
#define MBED_CONF_PLATFORM_MINIMAL_PRINTF_ENABLE_FLOATING_POINT \
  1  // set by application[*]
#define MBED_CONF_PLATFORM_MINIMAL_PRINTF_SET_FLOATING_POINT_MAX_DECIMALS \
  6                                                   // set by application[*]
...
#define MBED_CONF_PLATFORM_STDIO_CONVERT_TTY_NEWLINES \
  1                                               // set by library:platform
#define MBED_CONF_PLATFORM_STDIO_FLUSH_AT_EXIT 1  // set by library:platform
#define MBED_CONF_PLATFORM_STDIO_MINIMAL_CONSOLE_ONLY \
  0                                               // set by library:platform
...
#define MBED_CONF_QUECTEL_EC2X_START_TIMEOUT \
  15000                                           // set by library:QUECTEL_EC2X
...
#define MBED_CONF_RTOS_IDLE_THREAD_STACK_SIZE_DEBUG_EXTRA \
  128  // set by library:rtos[STM]
#define MBED_CONF_RTOS_IDLE_THREAD_STACK_SIZE_TICKLESS_EXTRA \
  256                                               // set by library:rtos
...
#define MBED_CONF_STM32_EMAC_ETH_PHY_DUPLEXMODE \
  ETH_MODE_FULLDUPLEX  // set by library:stm32-emac
#define MBED_CONF_STM32_EMAC_ETH_PHY_DUPLEX_STATUS \
  0x0010  // set by library:stm32-emac
#define MBED_CONF_STM32_EMAC_ETH_PHY_MEDIA_INTERFACE \
  ETH_MEDIA_INTERFACE_RMII  // set by library:stm32-emac
#define MBED_CONF_STM32_EMAC_ETH_PHY_RESET_DELAY \
  500  // set by library:stm32-emac
#define MBED_CONF_STM32_EMAC_ETH_PHY_SPEED \
  ETH_SPEED_100M  // set by library:stm32-emac
#define MBED_CONF_STM32_EMAC_ETH_PHY_SPEED_STATUS \
  0x0004  // set by library:stm32-emac
#define MBED_CONF_STM32_EMAC_ETH_PHY_STATUS_REGISTER \
  31                                                // set by library:stm32-emac
...
#define MBED_CONF_STORAGE_FILESYSTEM_BLOCKDEVICE \
  default  // set by library:storage_filesystem
#define MBED_CONF_STORAGE_FILESYSTEM_EXTERNAL_BASE_ADDRESS \
  0  // set by library:storage_filesystem
#define MBED_CONF_STORAGE_FILESYSTEM_EXTERNAL_SIZE \
  0  // set by library:storage_filesystem
#define MBED_CONF_STORAGE_FILESYSTEM_FILESYSTEM \
  default  // set by library:storage_filesystem
#define MBED_CONF_STORAGE_FILESYSTEM_FOLDER_PATH \
  kvstore  // set by library:storage_filesystem
#define MBED_CONF_STORAGE_FILESYSTEM_INTERNAL_BASE_ADDRESS \
  0  // set by library:storage_filesystem
#define MBED_CONF_STORAGE_FILESYSTEM_MOUNT_POINT \
  kv  // set by library:storage_filesystem
...
#define MBED_CONF_STORAGE_FILESYSTEM_RBP_INTERNAL_SIZE \
  0  // set by library:storage_filesystem
#define MBED_CONF_STORAGE_STORAGE_TYPE default  // set by library:storage
#define MBED_CONF_STORAGE_TDB_EXTERNAL_BLOCKDEVICE \
  default  // set by library:storage_tdb_external
...
#define MBED_CONF_STORAGE_TDB_EXTERNAL_NO_RBP_EXTERNAL_SIZE \
  0  // set by library:storage_tdb_external_no_rbp
#define MBED_CONF_STORAGE_TDB_EXTERNAL_RBP_INTERNAL_SIZE \
  0  // set by library:storage_tdb_external
#define MBED_CONF_STORAGE_TDB_INTERNAL_INTERNAL_BASE_ADDRESS \
  0  // set by library:storage_tdb_internal
#define MBED_CONF_STORAGE_TDB_INTERNAL_INTERNAL_SIZE \
  0  // set by library:storage_tdb_internal
...
#define MBED_CONF_TARGET_INTERNAL_FLASH_UNIFORM_SECTORS \
  0                                              // set by target:MCU_STM32F4
...
#define MBED_CONF_TARGET_LPUART_CLOCK_SOURCE  \
  USE_LPUART_CLK_LSE | USE_LPUART_CLK_PCLK1 | \
      USE_LPUART_CLK_PCLK3                       // set by target:MCU_STM32
#define MBED_CONF_TARGET_LSE_AVAILABLE 1         // set by target:MCU_STM32
#define MBED_CONF_TARGET_MPU_ROM_END 0x0fffffff  // set by target:Target
#define MBED_CONF_TARGET_RTC_CLOCK_SOURCE \
  USE_RTC_CLK_LSE_OR_LSI                            // set by target:MCU_STM32
...
// #define MBED_MINIMAL_PRINTF // defined by application
#define NSAPI_PPP_AVAILABLE \
  (MBED_CONF_PPP_ENABLED || \
   MBED_CONF_LWIP_PPP_ENABLED)  // defined by library:ppp
#define NSDYNMEM_TRACKER_ENABLED \
  MBED_CONF_NANOSTACK_LIBSERVICE_NSDYNMEM_TRACKER_ENABLED  // defined by
